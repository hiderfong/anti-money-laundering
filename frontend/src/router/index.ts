  ...
  routes: [
    ...
    },
    {
      ...
      children: [
        ...
        { path: 'organizations', name: 'OrganizationManagement', component: () => import('@/views/organization/OrganizationManagementView.vue'), meta: { title: '机构治理', titleKey: 'menu.organizations', roles: ['ROLE_ADMIN', 'ROLE_AML_MANAGER', 'ROLE_AML_OFFICER', 'ROLE_COMPLIANCE'], permissions: ['organization:view'] } },
        { path: 'integrations', name: 'IntegrationCenter', component: () => import('@/views/integration/IntegrationCenterView.vue'), meta: { title: '集成中心', titleKey: 'menu.integrations', roles: ['ROLE_ADMIN', 'ROLE_AML_MANAGER', 'ROLE_COMPLIANCE'], permissions: ['integration:view'] } },
